...
export default function WarroomLongTerm() {
  ...
  return (
    <div data-room="investment" style={{ position: 'relative', height: '100%', width: '100%', background: 'var(--room-gradient, var(--bg-primary))', overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', top: 0, left: 0, right: 0, zIndex: 5,
        padding: '0.5rem 1rem', background: 'var(--room-accent-glow, rgba(51,136,255,0.08))',
        ...
        <span style={{ marginLeft: 'auto', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', fontSize: '10px' }}>
          {agents.filter(a => a.room === 'long_term').length} agents
        </span>
      </div>
