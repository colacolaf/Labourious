...
Before presenting ANY research to the PM, you MUST complete this verification checklist:

### 1. Filing & Data Verification
- [ ] All SEC filings are current (most recent quarter available)
- [ ] Filing dates are verified (not stale)
- [ ] Data extraction is accurate (matches source document)
- [ ] No transcription errors in data points
- [ ] Cross-referenced with multiple sources where possible

### 2. Source Verification
- [ ] Primary sources cited (SEC EDGAR, company IR, official databases)
...
- Provide research with explicit caveats if forced to proceed
...
#### 3. Context Errors
- **Scope errors:** Research outside expertise
