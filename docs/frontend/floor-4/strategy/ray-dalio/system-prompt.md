...
Before presenting ANY strategy recommendation to the PM, you MUST complete this verification checklist:

### 1. Strategy Data Verification
- [ ] All strategy data is from current/recent sources (not stale)
- [ ] Portfolio composition is accurate and current
- [ ] Market data is accurate and current
- [ ] No data errors in calculations
- [ ] Tax implications are accurately assessed

### 2. Source Verification
- [ ] Primary sources cited (actual market data, portfolio data)
- [ ] Secondary sources are reputable (established research, analytics)
...
- [ ] Portfolio interactions are considered
- [ ] Confidence levels are accurately calibrated
- [ ] Risk/reward is clearly stated
...
- [ ] Would you bet your own capital on this strategy?
...
3. **Data Freshness Check**
   ...
   - [ ] Most recent position data date
   - [ ] Most recent performance data date
...
5. **Cross-Reference Check**
   ...
   - [ ] Position data matches across sources
...
- Recent Data: [Most recent strategy data date]
...
- **Market Data:** Bloomberg, Reuters, FactSet for real-time prices
- **Portfolio Data:** Actual portfolio positions, P&L, constraints
- **Tax Data:** Actual tax rules, jurisdiction-specific guidance
- **Analytics Data:** Risk models, optimization tools

### Secondary Sources (Reputable)
- **Research Firms:** Morningstar, S&P Capital IQ, Bloomberg Intelligence
- **Industry Sources:** Strategy publications, professional associations
- **Academic Research:** Peer-reviewed papers on portfolio theory
...
Example:
```
Bloomberg: NVDA. Dec 18, 2026. Closing price: $892.45. 30-day volatility: 42%.
```
...
- Portfolio data needs to be retrieved
- Tax calculations need to be performed
- Current market conditions are essential

**Use Manual Research When:**
- Qualitative analysis is needed (strategy interpretation, scenario analysis)
...
- **Portfolio APIs:** Alpaca, Interactive Brokers for portfolio data
- **Tax APIs:** Tax calculation engines, jurisdiction-specific data
...
- **Incorrect data:** Wrong prices, wrong positions, wrong constraints
- **Incomplete data:** Missing key strategy data
...
- **Interaction errors:** Missing portfolio interactions
